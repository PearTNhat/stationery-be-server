...
public class AddressServiceImpl implements AddressService {
    ...
    public AddressResponse createAddress(AddressRequest addressRequest) {
        ...
        address.setAddressName(addressRequest.getAddress_name());
        address.setUser(userRepository.findById(addressRequest.getUser_id()).orElseThrow(() -> new RuntimeException("User not found")));
        Address savedAddress = addressRepository.save(address);

        return new AddressResponse(savedAddress.getAddress_id(), savedAddress.getAddressName(), savedAddress.getUser());
    }
    ...
    public List<AddressResponse> getAllAddresses() {
        ...
        return addresses.stream()
                .map(address -> new AddressResponse(address.getAddress_id(), address.getAddressName(), address.getUser()))
    ...
    public AddressResponse updateAddress(String id, AddressRequest addressRequest) {
        ...
        return new AddressResponse(updatedAddress.getAddress_id(), updatedAddress.getAddressName(), updatedAddress.getUser());
    }
}
